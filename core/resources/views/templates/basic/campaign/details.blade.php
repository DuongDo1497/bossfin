          ...
          <div class="event-details-area mt-50">
            <ul class="nav nav-tabs nav-tabs--style" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <a class="nav-link active" id="description-tab" data-bs-toggle="tab" data-bs-target="#description"
                  href="#description" role="tab" aria-controls="description"
                  aria-selected="true">@lang('Description')</a>
              </li>
              <li class="nav-item" role="presentation">
                <a class="nav-link" id="gallery-tab" data-bs-toggle="tab" data-bs-target="#gallery" href="#gallery"
                  role="tab" aria-controls="gallery" aria-selected="false">@lang('Relevent Image')</a>
              </li>
              <li class="nav-item" role="presentation">
                <a class="nav-link" id="video-tab" data-bs-toggle="tab" data-bs-target="#document" href="#video"
                  role="tab" aria-controls="document" aria-selected="false">@lang('Relevent Document')</a>
              </li>

              <li class="nav-item" role="presentation">
                <a class="nav-link" id="review-tab" data-bs-toggle="tab" data-bs-target="#review" href="#review"
                  role="tab" aria-controls="review" aria-selected="false">@lang('Comments')</a>
              </li>
            </ul>
                      ...
                      <div class="col-lg-4 col-sm-6 mb-30">
                        <div class="gallery-card">
                          ...
                          <div class="gallery-card__thumb">
                            <img src="{{ asset(getFilePath('proof') . '/' . $images) }}" alt="@lang('image')">
                          </div>
              ...
              <div class="tab-pane fade" id="document" role="tabpanel" aria-labelledby="document-tab">
                @foreach ($campaign->proof_images as $pdfFiles)
                  @if (explode('.', $pdfFiles)[1] == 'pdf')
                    <iframe width="100%" height="800" src="{{ asset(getFilePath('proof') . '/' . $pdfFiles) }}"
                      frameborder="0"
                ...
                <form action="{{ route('campaign.comment') }}" method="POST">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-lg-6">
                      <input type="text" name="fullname" placeholder="@lang('Enter Name')" class="form-control"
                        required>
                    </div>
                    <div class="form-group col-lg-6">
          ...
          <div class="donation-sidebar">
            ...
            <div class="donation-widget">
              <form class="vent-details-form" method="POST"
                ...
                @csrf
                <h3 class="mb-3">@lang('Total Connections')</h3>
                <div class="form-row align-items-center">
                  <div class="col-lg-12 form-group donate-amount">
                    <div class="input-group mr-sm-2">
                      <div class="input-group-text">{{ $general->cur_sym }}</div>
                      <input type="number" id="donateAmount" class="form-control" value="0" name="amount"
                        required>
                    </div>
                  </div>
                  <div class="col-12 form-group donated-amount">
                    <div class="form--radio form-check-inline">
                      <input class="form-check-input donation-radio-check" type="radio" name="customRadioInline1"
                        value="100" id="customRadioInline1">
                    ...
                    <div class="form--radio form-check-inline">
                      <input class="form-check-input donation-radio-check" type="radio" name="customRadioInline1"
                        value="200" id="customRadioInline2">
                    ...
                    <div class="form--radio form-check-inline">
                      <input class="form-check-input donation-radio-check" type="radio" name="customRadioInline1"
                        value="300" id="customRadioInline3">
                      <label class="form-check-label" for="customRadioInline3">
                        {{ $general->cur_sym }}@lang('300')
                      </label>
                    </div>
                    <div class="form--radio form-check-inline">
                      <input class="form-check-input donation-radio-check custom-donation" type="radio"
                        name="customRadioInline1" id="flexRadioDefault4">
                ...
                @if ($general->anonymous_donation)
                  <div class="form--check mb-4">
                    <input class="form-check-input" type="checkbox" name="anonymous" id="checkdon" value="1">
                    <label class="form-check-label" for="checkdon">
                      @lang('Join Anonymous Campaign')
                    </label>
                  </div>
                @endif
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-lg-12">
                    ...
                    <input type="text" name="country" value="{{ old('country', @$user->address->country) }}"
                      class="form-control checktoggle"required>
                  </div>
                  <div class="col-lg-12">
                    <input type="hidden" name="campaign_id" value="{{ $campaign->id }}">
                    <button type="submit" class="cmn-btn w-100"
                      @if (@auth()->user()->id == $campaign->user_id) disabled @endif>@lang('JOIN US')</button>
                  </div>
                </div>
              </form>
            </div>
            ...
            <div class="donation-widget">
              ...
              <ul class="social-links mt-4">
                <li class="facebook face"><a target="_blank"
                ...
                <li class="whatsapp what"><a target="_blank"
                    href="https://wa.me/?text={{ urlencode(url()->current()) }}"><i class="fab fa-whatsapp"></i></a>
                </li>
              </ul>
            </div><!-- donation-widget end -->

            <div class="donation-widget pb-5">
              <h3 class="mb-4">@lang('Latest Connection')</h3>
              <ul class="donor-small-list">
                ...
                @if ($allDonors->count() > 4)
                  <li class="single">
                    <button type="button" class="donarModal cmn-btn w-100">@lang('See All Donors')</button>
                  </li>
                @endif
              </ul>
            </div><!-- donation-widget end -->
